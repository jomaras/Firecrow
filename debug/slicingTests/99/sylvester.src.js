...
Sylvester.Line.Segment.prototype = {
    ...
    translate: function (vector)
    {
        ...
        [S[0] + V[0], S[1] + V[1], S[2] + (V[2] || 0)], [E[0] + V[0], E[1] + V[1], E[2] + (V[2] || 0)]);
    },
    ...
    intersectionWith: function (obj)
    {
        ...
        else if (obj.normal)
        {
            ...
            var N = this.normal.elements,
                ...
                B = obj.anchor.elements;
            var solver = Sylvester.Matrix.Zero(2, 2),
                i = 0;
...
Sylvester.Plane.fromPoints = function (points)
{
    var np = points.length,
        list = [],
        i, P, n, N, A, B, C, D, theta, prevN, totalN = Sylvester.Vector.Zero(3);
    for (i = 0; i < np; i++)
    {
        ...
        if (n > 2)
        {
            ...
            (A[1] - B[1]) * (C[2] - B[2]) - (A[2] - B[2]) * (C[1] - B[1]), (A[2] - B[2]) * (C[0] - B[0]) - (A[0] - B[0]) * (C[2] - B[2]), (A[0] - B[0]) * (C[1] - B[1]) - (A[1] - B[1]) * (C[0] - B[0])]).toUnitVector();
            if (n > 3)
            {
    ...
    (A[1] - B[1]) * (C[2] - B[2]) - (A[2] - B[2]) * (C[1] - B[1]), (A[2] - B[2]) * (C[0] - B[0]) - (A[0] - B[0]) * (C[2] - B[2]), (A[0] - B[0]) * (C[1] - B[1]) - (A[1] - B[1]) * (C[0] - B[0])]).toUnitVector()).add(Sylvester.Vector.create([
    (B[1] - C[1]) * (D[2] - C[2]) - (B[2] - C[2]) * (D[1] - C[1]), (B[2] - C[2]) * (D[0] - C[0]) - (B[0] - C[0]) * (D[2] - C[2]), (B[0] - C[0]) * (D[1] - C[1]) - (B[1] - C[1]) * (D[0] - C[0])]).toUnitVector());
...
Sylvester.Polygon.prototype = {
    ...
    area: function ()
    {
        if (this.isTriangle())
        {
            ...
            (A[1] - B[1]) * (C[2] - B[2]) - (A[2] - B[2]) * (C[1] - B[1]), (A[2] - B[2]) * (C[0] - B[0]) - (A[0] - B[0]) * (C[2] - B[2]), (A[0] - B[0]) * (C[1] - B[1]) - (A[1] - B[1]) * (C[0] - B[0])]).modulus();
        }
        else
        {
