...
function parseValue(val, parent, level)
{
    ...
    if(typeof(val) == "object")
    {
        ...
        if(val instanceof Array)
        {
            ...
            var out = "<div class='wrap'>\n<div class='array' onmouseover='doFocus(event, this);'>\n<span class='widgets'><img src='jsonVisualizer/images/min.gif' onclick='hideChild(this);' /></span>\n<span class='titled' title='" + parent + "'>Array</span>\n";
        ...
        else
        {
            ...
            var objectTitle = val != null && val.type != null ? val.type + (val.codeConstruct != null ? "@" + (val.codeConstruct.loc != null ? val.codeConstruct.loc.start.line : '?') : "") : "Object";

            var out = "<div class='wrap'>\n<div class='object' onmouseover='doFocus(event, this);'>\n<span class='widgets'><img src='jsonVisualizer/images/min.gif' onclick='hideChild(this);' /></span>\n<span class='titled' title='" + parent + "'>" + objectTitle + "</span>\n";
...
function getJSONHTML(jsonString)
{
    return parse(escapeHTML(jsonString), null);
}
...
function hideChild(ele)
{
    ...
    for(i = 0; i < nodes.length; i++)
    {
        if(nodes[i].tagName == "TABLE")
        {
            ...
            ele.src = (minimizing ? "jsonVisualizer/images/max.gif" : "jsonVisualizer/images/min.gif");
