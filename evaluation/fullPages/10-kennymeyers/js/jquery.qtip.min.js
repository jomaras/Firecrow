...
(function (a, b, c)
{
    ...
    function z(b, c)
    {
        ...
        l = a.extend(d,
            {}, g.defaults, c, typeof r === "object" ? x(r) : f, x(q || p)), j = l.position, l.id = b;
        if ("boolean" === typeof l.content.text)
        {
            ...
            {
                w("Unable to locate content for tooltip! Aborting render of tooltip on element: ", m);
                return e
            }
        }
        ...
        if (a.data(this, "qtip"))
            if (l.overwrite) m.qtip("destroy");
            else if (l.overwrite === e) return e;
        a.attr(this, "title") && (a.attr(this, u, a.attr(this, "title")), this.removeAttribute("title")), i = new y(m, l, b, !! k), a.data(this, "qtip", i), m.bind("remove.qtip", function ()
        {
            i.destroy()
        });
        return i
    ...
    function y(c, s, t, w)
    {
        ...
        function P()
        {
            ...
            D.bind("mouseenter", function (a)
            {
                y.focus(a);
                D.toggleClass(q, b)
            });
            D.bind("mouseleave", function (a)
            {
                D.toggleClass(q, b)
            });
            s.hide.fixed && (h.hide = h.hide.add(D), D.bind("mouseover", function ()
            {
                D.hasClass(m) || clearTimeout(y.timers.hide)
            }));
            /mouse(out|leave)/i.test(s.hide.event) ? s.hide.leave === "window" && h.window.bind("mouseout", function (a)
            {
                /select|option/.test(a.target) && !a.relatedTarget && y.hide(a)
            }) : /mouse(over|enter)/i.test(s.show.event) && h.hide.bind("mouseleave", function (a)
            {
                clearTimeout(y.timers.show)
            });
            ("" + s.hide.event).indexOf("unfocus") > -1 && h.document.bind("mousedown", function (b)
            {
                var d = a(b.target),
            ...
            f.target === "mouse" && (h.show.bind("mousemove", function (a)
            {
                i = {
                    pageX: a.pageX,
                    pageY: a.pageY,
            ...
            }), f.adjust.mouse && (s.hide.event && D.bind("mouseleave", function (a)
            {
                (a.relatedTarget || a.target) !== h.show[0] && y.hide(a)
            }), h.document.bind("mousemove", function (a)
            {
        ...
        function N(b, d)
        {
            var f = F.title;
            if (!y.rendered || !b) return e;
            a.isFunction(b) ? (b = b.call(c, G.event, y), b === e && J()) : b.jquery && b.length > 0 ? f.empty().append(b.css(
                {
                    display: "block"
        ...
        y.id = t, y.rendered = e, y.elements = F = {
        ...
        }, a.extend(y,
            {
                render: function (b)
                {
                    ...
                    a.attr(c[0], "aria-describedby", A), D = F.tooltip = a("<div/>",
                        {
                            id: A,
                ...
                set: function (b, c)
                {
                    ...
                    var g = /^position\.(my|at|adjust|target|container)|style|content|show\.ready/i,
                        ...
                        k = y.checks,
                        l;
                    "string" === typeof b ? (l = b, b = {}, b[l] = c) : b = a.extend(d,
                ...
                toggle: function (b, c)
                {
                    ...
                    a.attr(D[0], "aria-hidden", !b), b ? (G.origin = a.extend(
                        {}, i), y.focus(c), a.isFunction(m.text) && O(m.text, e), a.isFunction(m.title.text) && N(m.title.text, e), !v && l.target === "mouse" && l.adjust.mouse && (a(document).bind("mousemove.qtip", function (a)
                    {
                        i = {
                            pageX: a.pageX,
                            pageY: a.pageY,
                ...
                reposition: function (c, d)
                {
                    ...
                    if (a.isArray(f) && f.length === 2) l = {
                        ...
                        x: "left",
                        y: "top"
                    }, c = c && (c.type === "resize" || c.type === "scroll") ? G.event : c && c.pageX && c.type === "mousemove" ? c : i && i.pageX && (m.mouse || !c || !c.pageX) ?
                    {
                        pageX: i.pageX,
                        pageY: i.pageY
                    } : !m.mouse && G.origin && G.origin.pageX ? G.origin : c, w = {
                        top: c.pageY,
                        left: c.pageX
                    };
                    else
                    ...
                    w.left += m.x + (j.x === "right" ? -o : j.x === "center" ? -o / 2 : 0), w.top += m.y + (j.y === "bottom" ? -p : j.y === "center" ? -p / 2 : 0), v.jquery && f[0] !== b && f[0] !== z && A.vertical + A.horizontal !== "nonenone" ? (v = {
                        elem: v,
                    ...
                    }).addClass(k + "-pos-" + j.abbreviation()), t.originalEvent = a.extend(
                        {}, c), D.trigger(t, [y, w, v.elem || v]);
                    if (t.isDefaultPrevented()) return y;
                    delete w.adjusted, d === e || isNaN(w.left) || isNaN(w.top) || f === "mouse" || !a.isFunction(g.effect) ? D.css(w) : a.isFunction(g.effect) && (g.effect.call(D, y, a.extend(
                        {}, w)), D.queue(function (b)
                    {
                        a(this).css(
                            {
                                opacity: "",
    ...
    }, g.bind = function (b, f)
    {
        return this.each(function (i)
        {
            function q(b)
            {
                ...
                o.cache.event = a.extend(
                    {}, b), o.cache.target = b ? a(b.target) : [c], k.show.delay > 0 ? (clearTimeout(o.timers.show), o.timers.show = setTimeout(d, k.show.delay), m.show !== m.hide && l.hide.bind(m.hide, function ()
                {
