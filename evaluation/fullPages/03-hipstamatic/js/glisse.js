 ...
 */ (function (a) {
    a.glisse = function (b, c) {
        ...
        var e = a(b),
            ...
            j = {}, k = [];
        d.init = function () {
            d.settings = a.extend({}, f, c), a.MobileDevice = navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPod/i) || navigator.userAgent.match(/Android/i), a.Tablet = navigator.userAgent.match(/iPad/i), g = a(e).attr(d.settings.dataName), h = e.attr("rel") || null, d.settings.mobile = a.Tablet || a.MobileDevice ? !0 : !1, e.on("click", function () {
