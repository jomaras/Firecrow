...
(function (a) {
    ...
    d = {
        ...
        updateChild: function (b, c, e, f) {
            ...
            var left = (g.x * c.midStage.width + c.nudge.width - g.width / 2) + "px";
            var top = (g.y * c.midStage.height + c.nudge.height - g.height / 2) + "px";
        ...
        isInFocus: function (a,log) {
            ...
            myGlobalVar.push({
                ...
                f: f,
                eBearing:e.bearing,
                result: b <= e.floatComparisonThreshold || b >= 360 - e.floatComparisonThreshold
            });
